...
public class ReserverTest {
    public static void main(String[] args){
        ...
        // show be all fine
        ReserveResult result1 = reserver.reservePlan(plan1);
        ...
        ReserveResult result2 = reserver.reservePlan(plan2);
        ...
        ReserveResult result3 = reserver.reservePlan(plan3);
        ...
        ReserveResult result4 = reserver.reservePlan(plan4);
